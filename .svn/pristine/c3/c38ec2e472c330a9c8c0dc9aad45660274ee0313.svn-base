 ...
 * @param $scope
 */
let tbHivSubController = function ($scope, $state, $q, vm, modal, toastr, blockUI, focusFlatPick, openSelectBox, labTestService) {
    ...
    vm.saveCD4Entry = function () {
        ...
        angular.copy(vm.patient.caseOrgs[0].organization, vm.cd4Entry.organization);

        // Copy the case
        vm.cd4Entry.theCase = {};
        angular.copy(vm.patient, vm.cd4Entry.theCase);
