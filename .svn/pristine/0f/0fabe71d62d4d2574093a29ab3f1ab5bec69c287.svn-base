...
(function () {
    ...
    angular.module('PDMA.PNS').service('PnsEditService', PnsEditService);

    PnsEditService.$inject = [
        '$http',
        '$q',
        'settings',
        'Utilities'
    ...
    function PnsEditService($http, $q, settings, utils) {
        let self = this;
        ...
        self.getPNSContactEntry=getPNSContactEntry;
        ...
        function getPNSContactEntry(id){
            if (!id) {
                return $q.when(null);
            }
