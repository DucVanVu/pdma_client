...
//                    formatter: _dateFormatter,
                ...
                , {
                    field: 'testDate',
                    title: 'Ngày xét nghiệm HIV lần này',
                    switchable: false,
                    visible: true,
                    formatter: _dateFormatter,
                    cellStyle: _cellNowrap
                ...
                , {
                    field: 'prepDate',
                    title: 'Ngày đăng ký sử dụng PrEP',
                    switchable: false,
                    visible: true,
                    formatter: _dateFormatter,
                    cellStyle: _cellNowrap
                     ...
                     field: 'arvDate',
                     title: 'Ngày đăng ký điều trị ARV',
                     switchable: false,
                     visible: true,
                     formatter: _dateFormatter,
                     cellStyle: _cellNowrap
                ...
                , {
                    field: 'totalCoupon',
                    title: 'Tổng số thẻ mời phát cho CTV',
                    switchable: false,
                    visible: true,
                    cellStyle: _cellNowrap
                }
