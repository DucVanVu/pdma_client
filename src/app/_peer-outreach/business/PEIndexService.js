        ...
        function getTableDefinition(isSiteManager, sortField1, sortField2, sortField3) {
            ...
            let columns = [
                ...
                },
                {
                    field: 'c1',
                    // title: 'Kỳ báo cáo',
                    title: '<div class="header-with-sorter">Kỳ báo cáo<span title="Sắp xếp theo kỳ báo cáo" style="margin-left: 10px"><a data-ng-show="'+!sortField1+' || '+sortField1+' == '+2+' " ng-click="$parent.sort1(1);" href="#"><i class="fa ' + _sortIcon1 + '"></i></a><a ng-click="$parent.sort1(2);" href="#"><i data-ng-show="'+sortField1+' == ' + 1 +'" class="fa ' + _sortIcon2 + '"></i></a><span></div>',
                    switchable: false,
                    visible: true,
                ...
                , {
                    ...
                    title: '<div class="header-with-sorter">Kết quả XN HIV lần này<span title="Sắp xếp theo Kết quả XN HIV lần này" style="margin-left: 10px"><a data-ng-show="'+!sortField3+' || '+sortField3+' == '+6+' " ng-click="$parent.sort3(5);" href="#"><i class="fa ' + _sortIcon1 + '"></i></a><a ng-click="$parent.sort3(6);" href="#"><i data-ng-show="'+sortField3+' == ' + 5 +'" class="fa ' + _sortIcon2 + '"></i></a><span></div>',
                    switchable: false,
                    visible: true,
